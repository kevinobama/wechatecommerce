...
class Jssdk {
  ...
  private function getJsApiTicket() {
    ...
    $data = json_decode(file_get_contents("/var/www/php/wechatecommerce/storage/app/public/jsapi_ticket.json"));
  ...
  private function getAccessToken() {
    ...
    $data = json_decode(file_get_contents("/var/www/php/wechatecommerce/storage/app/public/access_token.json"));
    if ($data->expire_time < time()) {
