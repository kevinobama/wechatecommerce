...
function write($data, $isDelete = false)
{
...
$myCkpath = "/ckeditor/plugins/imageuploader/uploads/";
...
write("myCkpath=".$myCkpath);
$ckfile = $myCkpath . $filename;
write("ckfile=".$ckfile);
$uploadOk = 1;
